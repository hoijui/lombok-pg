...
public class HandleObservedAttribute extends JavacAnnotationHandler<ObservedAttribute> {

	@Override
	public void handle(final AnnotationValues<ObservedAttribute> annotation, final JCAnnotation ast, final JavacNode annotationNode) {
		...
		deleteAnnotationIfNeccessary(annotationNode, ObservedAttribute.class);
